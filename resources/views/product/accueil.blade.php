...
<html lang="en" class="light scroll-smooth" dir="ltr">
    ...
    <body class="dark:bg-slate-900">
                ...
                <ul class="buy-button list-none mb-0">
                    ...
                    <li class="dropdown inline-block relative ps-0.5">
                        <button data-dropdown-toggle="dropdown" class="dropdown-toggle items-center" type="button">
                            <span class="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-orange-500 bg-orange-500 text-white"><img src="https://shreethemes.in/cartzio/layouts/assets/images/client/16.jpg" class="rounded-full" alt=""></span>
                        </button>
                        <!-- Dropdown menu -->
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu megamenu">
                                ...
                                <li>
                                    <ul>
                                        <li class="megamenu-head"><img src="https://shreethemes.in/cartzio/layouts/assets/images/cta.png" alt=""></li>
                    ...
                    <div class="grid xl:grid-cols-6 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/smart-watch.jpg" class="group-hover:scale-110 duration-500" alt="">
                        ...
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/sunglasses.jpg" class="group-hover:scale-110 duration-500" alt="">
                                <span class="bg-white dark:bg-slate-900 group-hover:text-orange-500 py-2 px-6 rounded-full shadow dark:shadow-gray-800 absolute bottom-4 mx-4 text-lg font-medium">Sunglasses</span>
                            </a>
                        </div><!--end content-->
                        
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/chappal-shoes.jpg" class="group-hover:scale-110 duration-500" alt="">
                                <span class="bg-white dark:bg-slate-900 group-hover:text-orange-500 py-2 px-6 rounded-full shadow dark:shadow-gray-800 absolute bottom-4 mx-4 text-lg font-medium">Casual Shoes</span>
                            </a>
                        </div><!--end content-->
        
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/ladies-ware.jpg" class="group-hover:scale-110 duration-500" alt="">
                        ...
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/kids-ware.jpg" class="group-hover:scale-110 duration-500" alt="">
                        ...
                        <div class="relative overflow-hidden group rounded-md shadow dark:shadow-slate-800">
                            <a href="" class="text-center">
                                <img src="https://shreethemes.in/cartzio/layouts/assets/images/categories/mens-ware.jpg" class="group-hover:scale-110 duration-500" alt="">
        ...
        <section class="relative md:py-24 py-16">
            <div class="container relative">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/ladies-1.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/mens-jecket.jpg" class="group-hover:scale-110 duration-500" alt="">
        ...
        <!-- Start -->
        <section class="py-28 w-full table relative bg-[url('../../https://shreethemes.in/cartzio/layouts/assets/images/hero/bg6.jpg')] bg-center bg-no-repeat bg-cover">
            <!-- <div class="absolute inset-0 bg-slate-900/30"></div> -->
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    <h3 class="font-semibold text-3xl leading-normal mb-4 text-white">End of Season Clearance <br> Sale upto 30%</h3>

                    <p class="text-white/80 max-w-xl mx-auto">Upgrade your style with our curated sets. Choose confidence, embrace your unique look.</p>
        ...
        <section class="relative md:py-24 py-16">
            <div class="container relative">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/men-sun-glasses.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/women-s-white-low-heel-shoes.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/casual-men-shorts.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/luxurious-bag2.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/smart-watch.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/white-sandals-summer-footwear.jpg" class="group-hover:scale-110 duration-500" alt="">
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                            <img src="https://shreethemes.in/cartzio/layouts/assets/images/shop/ladies-skirt-pair.jpg" class="group-hover:scale-110 duration-500" alt="">
                        ...
                        <div class="tiny-single-item">
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " Cartzio made the processes so easy. Cartzio instantly increased the amount of interest and ultimately saved us over $10,000. " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/01.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " I highly recommend Cartzio as the new way to sell your home "by owner". My home sold in 24 hours for the asking price. Best $400 you could spend to sell your home. " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/02.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/03.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/04.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " Cartzio made selling my home easy and stress free. They went above and beyond what is expected. " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/05.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " Cartzio is fair priced, quick to respond, and easy to use. I highly recommend their services! " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/client/06.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
                                        <h6 class="mt-2 font-medium">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="grid md:grid-cols-12 grid-cols-1 gap-6">
                                <div class="lg:col-span-3 md:col-span-12">
                                    <a href="#" class="text-[22px] focus:outline-none">
                                        <img src="https://shreethemes.in/cartzio/layouts/assets/images/logo-light.png" alt="">
                                    </a>
