        ...
        <div class="flex items-center justify-end mt-4">
            <div class="flex text-xs">
                @if (Route::has('register'))
                    ...
                    &nbsp; &nbsp;
                    <a class="underline text-sm text-gray-600 hover:text-orange-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500" href="{{ route('password.request') }}">
                        {{ __('Mot de passe oublié?') }}
                    </a>
                @endif
            </div>

            <x-orange-button class="ms-3">
                {{ __('Log in') }}
            </x-orange-button>
        </div>
    </form>
